        ...
        <div className='flex flex-col w-full  '>
            <div className=' flex p-20'>
                <div className='flex flex-col w-full h-[500px] justify-center'>
                    ...
                    <div>
                        <button className='px-5 py-2.5 bg-green-500 text-white  mt-5 rounded-md'>
                            Torne-se motorista
                        </button>
                    </div>
                </div>
            ...
            <div className='flex flex-col bg-green-500 text-white p-10 mx-20 mt-20 rounded-lg'>
                ...
                <div className='flex  justify-center items-center mb-20 w-full '>
                    <div className='flex flex-col justify-center items-center w-full text-center'>
                        ...
                        <p>Ganhe dinheiro  com a sua <br /> viatura</p>
                    </div>
                    <div className='flex flex-col justify-center items-center w-full text-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-20 h-20">
                        ...
                        <p>O nosso aplicativo está disponível <br /> para Android e IOS</p>
                    </div>
                    <div className='flex flex-col justify-center items-center w-full text-center'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-20 h-20">
                        ...
                        <p>Atualização em tempo real no mapa</p>
                    </div>
                </div>
            </div>
            <div className=' flex w-full mt-20 p-20'>
                ...
                <div className='flex flex-col w-full h-[500px] justify-center'>
                    <p className='text-6xl font-bold'>GARANTIMOS O SEU CONFORTO</p>
            ...
            <div className=' flex w-full mt-10 border-t p-20'>

                <div className='flex flex-col w-full h-[500px] justify-center pr-40'>
                    <p className='text-6xl font-bold'>NÃO CONHECE O LOCAL PRA ONDE VAI?</p>
                    <p className='mt-10 text-gray-500'>Não se preocupa, basta colocar o seu destino que o aplicativo trata do resto. Você pode salvar os locais mais frequentados para um acesso rápido 😉</p>
